  ...
  def index
    ...
    if params[:uniq_cohort].present?
      if params[:uniq_cohort] == "1"
        ...
        @eg_cohorts = EpaMaster.get_eg_cohort(params[:uniq_cohort], Current.user.email)
      end
    ...
    respond_to do |format|
      format.html # renders index.html.erb (frames + partials)
