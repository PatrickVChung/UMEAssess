...
class UserDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    ls_list_state: Field::String,
    matriculated_date: Field::Date,
    new_competency: Field::Boolean,
    p4_program_id: Field::Text,
    password_digest: Field::String,
    permission_group: Field::BelongsTo,
    prev_permission_group_id: Field::Number,
