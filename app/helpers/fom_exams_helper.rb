...
def process_tab_sheet(permission_group_id, course_code, component, sub_component, sheet)
  ...
  def hf_create_graph_series(component, class_data, avg_data, categories, permission_group)
    ...
    series_data = [{name: 'Student', data: student_series},
                   {name: 'Class Mean', data: class_mean_series}]
