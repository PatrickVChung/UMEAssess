module EpaReviewsHelper
  ...
  EPA_KEYWORDS = {
            ...
            "EPA5" => ["document clinical encounter", "document", "documentation", "note", "notes","progress note", "written",  "written H&P", "written history and physical", "discharge summary"], # "Document a clinical encounter in the patient record",
            ...
            "EPA8" => ["patient care transfer", "handover", "handoff", "transition of care", "Signout", "hand offs", "sign offs", "sign outs"],  # "Give or receive a patient handover to transition care responsibility",
  ...
  # updated on 1/27/2026 - requested by Emily
  NEW_EPA_KEYWORDS = {
  ...
  "EPA7" => ["literature", "evidence", "literature search", "evidence-based medicine", "EBM", "research", "clinical question", "PICO",
    ...
    "randomized controlled trial", "RCT", "medical literature", "PubMed", "literature review", "clinical application"],

  "EPA8" => ["patient care transfers", "handovers", "handover", "handoff", "handoffs", "hand-off", "sign out", "sign-out", "transition of care", "transfer of care",
     "patient transfer", "I-PASS", "SBAR", "transfer of information", "continuity of care", "care transition", "shift change", "coverage",
     "cross-coverage", "signout", "hand over", "pass the baton", "transfer of responsibility"],

  "EPA9" => ["interprofessional", "collaboration", "team-based care", "multidisciplinary", "interdisciplinary", "healthcare team", "care team",
    "team communication", "consultation", "nurse", "pharmacist", "social worker", "case manager", "physical therapist", "occupational therapist",
    "respiratory therapist", "team approach", "care coordination", "coordinated care", "team member"],

  "EPA10" => ["urgent", "emergent", "emergency", "critical", "rapid response", "code", "code blue", "deterioration", "unstable", "escalation",
    "escalate care", "decompensation", "triage", "patient safety", "immediate intervention", "life-threatening", "critical situation", "acute change",
     "resuscitation", "CPR", "ACLS", "BLS"],

  "EPA11" => ["shared decision making", "shared decision-making", "informed consent", "patient preference", "treatment options", "patient values",
    "risk communication", "benefit-risk", "risks and benefits", "patient autonomy", "patient education", "decision aid", "informed choice",
    "patient-centered", "patient centered", "preference-sensitive", "decision support", "joint decision"]
}
